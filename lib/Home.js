...
import SwipeableDirection from './home/SwipeableDirection';
...
export default class Home extends Component {
  ...
  updateInfo(position) {
    ...
    if (position && position.coords) {
      Gtfs.getHomePageInfo(position.coords, (err, routes) => {
        this.safelySetState({
          routeData: this.state.routeData.concat(routes),
          loading: false,
          routeIdx: this.state.routeIdx + this.state.routePerPage
        });
      });
    }
  }
