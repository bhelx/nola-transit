...
export default class ReminderModal extends PureComponent {
  ...
  renderButton(scheduleDateTime, timeBefore) {
    ...
    return (
      <Button
        key={timeBefore}
        onPress={this.props.scheduleNotification.bind(this, scheduleDateTime - timeBefore, mins)} 
    ...
    return (
      <Modal isVisible={this.props.isVisible}>
        <View style={styles.ModalContent}>
          <Text>We can send you a reminder before this car arrives. When do you want it?</Text>
          {buttons}
        </View>
      </Modal>
    )
