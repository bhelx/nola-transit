...
export default class StopsListView extends Component {
  ...
  topSegment() {
    return (
      <View style={[styles.RouteLine, {paddingLeft: 5.5}]}>
        <View style={[styles.RouteLineSegmentUnfilled, {backgroundColor: '#fff'}]} />
        <View style={[styles.RouteLineSegmentBig, {backgroundColor: this.props.color}]}>
            <Text></Text>
        </View>
      ...
      <TouchableHighlight onPress={this.props.navigateToStop.bind(this, stop)}>
        <View style={styles.StopRow}>
          ...
          <View style={styles.StopDetails}>
            ...
            <Text style={styles.StopTime}>{dtString} - {timeAway}</Text>
          </View>
