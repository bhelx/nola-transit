    ...
    return (
      <TouchableHighlight onPress={this.onSchedulePress.bind(this, rowId)}>
        <View style={styles.ScheduleListItem}>
          <View>
            <Text style={[styles.ScheduleTime, {color: scheduleItem.upcoming ? '#000' : '#aaa'}]}>{Utils.dateToString(scheduleItem.datetime)}</Text>
          </View>
          {timeTil}
        </View>
      </TouchableHighlight>
  ...
  render() {
    return (
      <View style={styles.Container}>
        ...
        <View style={[styles.Route, {backgroundColor: `#${this.props.route.route_color}`}]}>
          <RouteShield
            backgroundColor='#fff'
            textColor='#000'
          ...
          <View style={styles.RouteName}>
            <Text
              ellipse="tail"
              numberOfLines={1}
              style={[styles.RouteNameText, {color: `#${this.props.route.route_text_color}`}]}>
                {this.props.direction.trip_headsign}
            </Text>
          </View>
        </View>
        <ListView
        ...
        <ScheduleBottomBar
          ...
          color={`#${this.props.route.route_color}`}
        />
      </View>
    );
  }
