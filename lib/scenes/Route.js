...
export default class Route extends Component {
  ...
  render() {
    ...
    let coordinates = this.state.direction === 'to_audobon' ? toAudobon : toCanal;
    let stops = this.state.direction === 'to_audobon' ? toAudobonStops : toCanalStops;
    let view = React.createElement(this.state.view, {coordinates, stops, navigator: this.props.navigator})
        ...
        <TouchableHighlight onPress={this.onViewChange.bind(this)}>
          <View style={[styles.Route, {backgroundColor: '#9B5AA5'}]}>
            ...
            <View style={styles.MapIcon}>
              <Icon size={20} name="map-o" color="#FFF" />
            </View>
          </View>
        </TouchableHighlight>
        {view}
