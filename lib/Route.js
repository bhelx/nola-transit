...
export default class Route extends Component {
  ...
  constructor(props) {
    ...
    this.state = { appState: AppState.currentState, directionId: null };
  ...
  clearInfo() {
    console.log('Route clear info');
    this.setState({
      stops: null,
      loading: true,
    });
  }
  updateInfo(position, unsafe) {
      ...
      if (!results.stops || results.stops.length == 0) {
        ...
        let update = {
          ...
          directionId: this.state.directionId ||
            this.props.navigation.state.params.route_idx,
